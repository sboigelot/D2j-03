...
var plant_3d_inspector_plugin:EditorInspectorPlugin
...
func _enter_tree():
	...
	plant_3d_inspector_plugin = preload("plant_3d_inspector_plugin.gd").new()
	add_inspector_plugin(plant_3d_inspector_plugin)

func _exit_tree():
	if csgbox_inspector_plugin:
		remove_inspector_plugin(water_node_3d_inspector_plugin)
	if water_node_3d_inspector_plugin:
		remove_inspector_plugin(water_node_3d_inspector_plugin)
	if plant_3d_inspector_plugin:
		remove_inspector_plugin(plant_3d_inspector_plugin)
